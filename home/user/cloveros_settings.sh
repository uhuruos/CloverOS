...
case "$choice" in
	...
	6)
		...
		mkdir $backupdir
		rm .fvwm2rc
		mv .bash_profile .zprofile .zshrc .Xdefaults wallpaper.png .xbindkeysrc screenfetch-dev bl.sh cloveros_settings.sh stats.sh rotate_screen.sh .emacs .emacs.d .rtorrent.rc .mpv .config/xfe/ .config/nitrogen/ $backupdir/

...
case "$choice" in
	...
	zz)
		...
		sudo emerge --depclean || sudo emerge -1 virtual/perl-ExtUtils-MakeMaker virtual/perl-File-Spec virtual/perl-File-Path sys-apps/texinfo dev-perl/libintl-perl dev-perl/XML-Parser dev-perl/Unicode-EastAsianWidth dev-perl/Text-Unidecode && sudo emerge --depclean

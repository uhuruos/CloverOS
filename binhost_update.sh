...
if [ "$1" = 'deep' ]; then
	...
	emerge -B sudo openssh glibc baselayout sysvinit linux-firmware dcron cronie fcron anacron chromium torbrowser-launcher mail-mta/postfix acct-user/postfix acct-group/postfix
fi

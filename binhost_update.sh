...
rsync -av --delete-after /usr/portage/packages/ root@useast.cloveros.ga:/var/www/htdocs/cloveros.ga/ &
rsync -av --delete-after /usr/portage/packages/ root@uswest.cloveros.ga:/var/www/htdocs/cloveros.ga/ &
rsync -av --delete-after /usr/portage/packages/ root@au.cloveros.ga:/var/www/htdocs/cloveros.ga/ &

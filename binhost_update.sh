...
if [ "$1" = 'deep' ]; then
	...
	emerge -C hwinfo ntfs3g ; emerge ntfs3g ; emerge hwinfo; emerge -C dbus obs ; emerge obs ; emerge -1 dbus; emerge -C jack-audio-connection-kit audacity ; emerge audacity ; emerge jack-audio-connection-kit

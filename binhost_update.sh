...
rsync -a /usr/portage/packages/ root@useast.cloveros.ga:/var/www/htdocs/cloveros.ga/ &
rsync -a /usr/portage/packages/ root@uswest.cloveros.ga:/var/www/htdocs/cloveros.ga/ &
rsync -a /usr/portage/packages/ root@au.cloveros.ga:/var/www/htdocs/cloveros.ga/ &
rsync -a /usr/portage/packages/ root@fr.cloveros.ga:/var/www/html/ &
wait

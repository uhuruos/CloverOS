...
rm -R /usr/portage/packages/s/nodbus/ ; mkdir /usr/portage/packages/s/nodbus/ && PKGDIR="/usr/portage/packages/s/nodbus/" USE="-qt5 -video-thumbnails savedconfig -video_cards_radeon -video_cards_radeonsi -llvm -opencl -dbus -trash-panel-plugin" emerge -B glib qtgui thunar spacefm wpa_supplicant poppler gpgme mesa linux-firmware desktop-file-utils freedesktop-icon-theme

...
genkernel --kernel-config=config-arch-64 --luks all # --lvm
...
genkernel --kernel-config=config-arch-64 --luks --kerneldir=/usr/src/linux-$kernelversion-gentoo-gnu/ all # --lvm

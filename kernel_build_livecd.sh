...
XZ_OPT="--lzma1=preset=9e,dict=128MB,nice=273,depth=200,lc=4" tar --lzma -cf /usr/portage/packages/s/kernel-livecd-libre.tar.lzma /boot/*$kernelversion-aufs-gnu /lib/modules/$kernelversion-aufs-gnu &

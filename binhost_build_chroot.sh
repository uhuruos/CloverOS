...
emerge layman
layman -S
yes | layman -a 0x4d4c 4nykey abendbrot audio-overlay bar brother-overlay chaos deadbeef-overlay dotnet elementary erayd eroen farmboy0 FireBurn fkmclane flatpak-overlay flussence gamerlay genthree haskell jacendi-overlay jm-overlay jorgicio libressl linxon luke-jr palemoon pentoo petkovich pinkpieea poly-c raiagent rasdark science seden sk-overlay spikyatlinux steam-overlay stefantalpalaru tlp torbrowser vampire vapoursynth

...
PORTAGE_BINHOST="https://cloveros.org/s/nodbus" FETCHCOMMAND_HTTPS="wget -O \"\\\${DISTDIR}/\\\${FILE}\" \"\\\${URI}\"" emerge -1O glib wpa_supplicant gpgme spacefm linux-firmware mesa
